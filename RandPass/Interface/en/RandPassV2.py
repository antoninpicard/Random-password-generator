...
class PasswordGeneratorApp:
    def __init__(self):
        ...
        self.symbols_checkbox = tk.Checkbutton(self.window, text="Include symbols", variable=self.symbols_var)
        ...
        self.copy_button = tk.Button(self.window, text="Copy", command=self.copy_password)
        self.copy_button.pack(pady=10)

        self.website_label = tk.Label(self.window, text="Website:")
        self.website_entry = tk.Entry(self.window)

        self.save_button = tk.Button(self.window, text="Save password", command=self.save_password)
